...
spawn(function() 
    ...
    notis.new("<Color=Yellow>Executor:<Color=/> ".. identifyexecutor()):Display() 
        task.wait()
    ...
    wait(.14)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Please Join My Discord :><Color=/>"):Display()
    wait(.24)
end)
...
local W = Window:MakeTab({ Name = " About Tab",Icon = "rbxassetid://17510500831",PremiumOnly = false})
local SH = Window:MakeTab({Name = " Shop Tab",Icon = "rbxassetid://17510500831",PremiumOnly = false})
local M = Window:MakeTab({Name = " Farming Tab",Icon = "rbxassetid://17510500831",PremiumOnly = false})
local IQ = Window:MakeTab({Name = " Sub Farming Tab",Icon = "rbxassetid://17510500831",PremiumOnly = false})
local G = Window:MakeTab({Name = " Sea Event Tab",Icon = "rbxassetid://17510500831",PremiumOnly = fals})
local S = Window:MakeTab({Name = " Stats Tab",Icon = "rbxassetid://17510500831",PremiumOnly = false})
local E = Window:MakeTab({Name = " ESP Tab",Icon = "rbxassetid://17510500831",PremiumOnly = false})
local RA = Window:MakeTab({ Name = " Raid Tab",Icon = "rbxassetid://17510500831",PremiumOnly = false})
local LC = Window:MakeTab({Name = " Local Player Tab",Icon = "rbxassetid://17510500831",PremiumOnly = false})
local Wld = Window:MakeTab({Name = " Sea TP Tab",Icon = "rbxassetid://17510500831",PremiumOnly = false})
local SV = Window:MakeTab({Name = " Status and Server",Icon = "rbxassetid://17510500831",PremiumOnly = false})
local D = Window:MakeTab({Name = " Fruit Tab",Icon = "rbxassetid://17510500831",PremiumOnly = false})
local R = Window:MakeTab({Name = " Upgrade Race",Icon = "rbxassetid://17510500831",PremiumOnly = false})
local C = Window:MakeTab({Name = " Misc Tab",Icon = "rbxassetid://17510500831",PremiumOnly = false})
local ST = Window:MakeTab({Name = " Settings Tab",Icon = "rbxassetid://17510500831",PremiumOnly = false})

IQ:AddSection({Name = "Kitsune Update"})
local KisuneUpToggle = IQ:AddToggle({Name = "Tween to Kitsune Island", Default = false, Callback = function(vKitsuneI)
    KitsuneI = vKitsuneI
...
local FarmAzure = IQ:AddToggle({Name = "Farm Azure Ember", Default = false, Callback = function(vAzuEmber)
    AzuEmber = vAzuEmber
...
W:AddLabel("さま┊Windy•Hub Community")
...
W:AddLabel("[+] さま┊Windy•Hub Rewrite Main")
W:AddLabel("[?] Developer: windyisreal")
W:AddLabel("[!] Script is beta have bug please report in discord server")
W:AddLabel("[?] Discord: discord.gg/windyhub")
W:AddLabel("[+] Script Fast Loading")
...
M:AddParagraph("Choose Weapon","Please Choose Weapon")
...
M:AddParagraph("Main Farm","Rewrite:333")
...
M:AddParagraph("Mastery Tab","Fuck Function MRT")
...
M:AddParagraph("Kaitun","Shit Kaitun")
...
TweenChest = M:AddToggle({
    ...
    M:AddToggle({
        Name = "Auto Chest[Reset]",
        Default = false,
        Flag = "Auto Chest[Reset]",
        Save = true,
        Callback = function(Value)
...
M:AddParagraph("Auto Farm Boss :","Wait For Update")
...
local Section = IQ:AddSection({
    Name = "Auto Dual Curset Katana[Soon]"
})
